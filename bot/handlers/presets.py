...
async def show_presets(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await message.reply_text(message_text, parse_mode="Markdown", reply_markup=keyboard)
...
async def handle_preset_callback(
...
async def show_preset_info(
    query: CallbackQuery, context: ContextTypes.DEFAULT_TYPE, preset_id: str
) -> None:
    """
...
async def show_preset_examples(
    query: CallbackQuery, context: ContextTypes.DEFAULT_TYPE, preset_id: str
) -> None:
    """
...
async def start_custom_topic_input(
    query: CallbackQuery, context: ContextTypes.DEFAULT_TYPE, preset_id: str
) -> None:
    """
...
@handle_errors("Error retrieving presets. Please try again later.")
async def show_presets_callback(
...
@handle_errors("Error showing preset information.")
async def show_general_preset_info(
    query: CallbackQuery, context: ContextTypes.DEFAULT_TYPE
) -> None:
    """
